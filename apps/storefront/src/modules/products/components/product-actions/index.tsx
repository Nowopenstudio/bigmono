...
export default function ProductActions({
  ...
  const hasUnselectedOptions = useMemo(() => {
    return (product.options || []).some((option) => !options[option.id])
    ...
    <div className="px-6">
      ...
      <div  ref={actionsRef} className="absolute bottom-0 left-0 right-0">
        ...
        <Button
          ...
          variant="primary"
          className={clx(
            "w-full bg-[white] border-[3px] border-black rounded-none text-black bg-[--red] navHold hover:bg-[--yellow] h-[55px] my-0",
            {
